...
// Enhanced category detection function (same as in upload route)
...
async function fixArticleCategories() {
  ...
  console.log(`⏭️  Skipped: ${skippedCount} articles (no change needed)`)
  ...
  console.log('\n🎉 Category reclassification complete!')
  console.log('💡 Your nutrition articles should now appear on the public site!')
}

// Run the script
fixArticleCategories().catch(console.error) 