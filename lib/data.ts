...
const getArticles = async (): Promise<Article[]> => {
  ...
  const transformedArticles = data
    ...
    .map(article => ({
      ...
      image: article.featured_image || 'https://images.pexels.com/photos/5327580/pexels-photo-5327580.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop',
  ...
  try {
    ...
    if (dbArticle) {
      ...
      article = {
        ...
        image: dbArticle.featured_image || 'https://images.pexels.com/photos/5327580/pexels-photo-5327580.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop',
