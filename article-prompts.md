...
### Using ChatGPT/OpenAI for Article Rewriting

The system is now configured to use OpenAI GPT-4 for all article rewrites. When articles are imported:

1. **Model**: GPT-4 (latest version)
...
### API Keys Required:
- `OPENAI_API_KEY`: For GPT-4 article rewriting (REQUIRED)
