    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
          <img src="https://images.unsplash.com/photo-1571019613540-996a5c9b6c6e?w=400&h=250&fit=crop" alt="Mental Health" class="w-full h-48 object-cover">
          <div class="p-6">
  ...
  <section class="mb-16">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
          <img src="https://images.unsplash.com/photo-1571019613540-996a5c9b6c6e?w=400&h=250&fit=crop" alt="Strength Training" class="w-full h-48 object-cover">
          <div class="p-6">
